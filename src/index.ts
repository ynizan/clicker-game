...
async function handleMCP(request: Request): Promise<Response> {
  ...
  if (method === 'tools/list') {
    const tools = [
      {
        name: "click",
        description: "Hustle to earn startup dollars based on your current multiplier",
      ...
      {
        name: "auto_click",
        description: "Passive income generated by your hired team members",
        inputSchema: { type: "object", properties: {} },
        annotations: {
          title: "Team Work",
          readOnlyHint: false,
      ...
      {
        name: "buy_multiplier",
        description: "Purchase startup upgrades like Coffee Machine, Pitch Deck, or AI Pivot",
        inputSchema: { type: "object", properties: {} },
        annotations: {
          title: "Buy Upgrade",
          readOnlyHint: false,
      ...
      },
      {
        ...
        description: "Hire team members like Interns, Growth Hackers, or AI Agents for passive income",
        inputSchema: { type: "object", properties: {} },
        annotations: {
      ...
      {
        name: "get_game_state",
        description: "View current funding, team size, multiplier, and startup stage",
        inputSchema: { type: "object", properties: {} },
        annotations: {
          title: "Check Startup Status",
          readOnlyHint: true,
          destructiveHint: false,
          openWorldHint: false
        }
      ...
      {
        name: "reset_game",
        description: "Abandon current startup and begin a new venture from scratch",
        inputSchema: { type: "object", properties: {} },
        annotations: {
          title: "Pivot (Start Over)",
          readOnlyHint: false,
